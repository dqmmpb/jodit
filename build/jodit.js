    ...
    video: {
        popup: function (editor, current, control, close) {
            ...
            if (editor.options.textIcons) {
                ...
                tab[icon_1.ToolbarIcon.getIcon('link') + '&nbsp;' + i18n('Link')] = bylink;
...
exports.MAY_BE_REMOVED_WITH_KEY = /^(A|IMG|BR|IFRAME|SCRIPT|INPUT|TEXTAREA|HR|JODIT|JODIT-MEDIA)$/i;
...
var alert_1 = __webpack_require__(201);
...
var StatusBar_1 = __webpack_require__(127);
...
var Jodit_1 = __webpack_require__(13);
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var filesize = __webpack_require__(85);
var Dom_1 = __webpack_require__(1);
var helpers_1 = __webpack_require__(2);
var icon_1 = __webpack_require__(6);
var Widget;
    ...
    Widget.FileSelectorWidget = function (editor, callbacks, elm, close, isImage) {
            ...
            editor.getInstance('Uploader').bind(dragbox, function (resp) {
                ...
                if (typeof handler === 'function') {
                    if (!isImage && resp.isImages) {
                        resp.isImages = resp.isImages.map(function (i) { return isImage && i; });
                    }
        ...
        if (callbacks.filebrowser) {
            if (editor.options.filebrowser.ajax.url ||
                ...
                tabs[icon + i18n('Browse')] = function () {
                    close && close();
                    if (callbacks.filebrowser) {
        ...
        if (callbacks.url) {
            ...
            if (elm &&
                ...
                button.textContent = i18n('Update');
            }
            if (elm &&
...
var fileBrowser_1 = __webpack_require__(202);
exports.FileBrowser = fileBrowser_1.FileBrowser;
var Helpers = __webpack_require__(2);
exports.Helpers = Helpers;
var ImageEditor_1 = __webpack_require__(208);
...
var Uploader_1 = __webpack_require__(209);
...
var inArray_1 = __webpack_require__(88);
exports.inArray = inArray_1.inArray;
var splitArray_1 = __webpack_require__(89);
...
var list_1 = __webpack_require__(134);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var view_1 = __webpack_require__(128);
var joditToolbarCollection_1 = __webpack_require__(20);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var break_1 = __webpack_require__(133);
var button_1 = __webpack_require__(27);
var separator_1 = __webpack_require__(135);
var Dom_1 = __webpack_require__(1);
var Component_1 = __webpack_require__(7);
var Config_1 = __webpack_require__(3);
var isJoditObject_1 = __webpack_require__(15);
...
var Snapshot_1 = __webpack_require__(58);
var Stack_1 = __webpack_require__(59);
var command_1 = __webpack_require__(126);
...
var Select = (function () {
                ...
                var forEvery_1 = function (current) {
                    ...
                    if (Dom_1.Dom.isTag(current, 'li')) {
                        if (current.firstChild) {
                            ...
                            var currentB = _this.jodit.create.inside.text(consts.EMPTY);
    ...
    Select.prototype.marker = function (atStart, range) {
        ...
        marker.appendChild(this.jodit.create.inside.text(consts.EMPTY));
        if (newRange) {
    ...
    Select.prototype.cursorInTheEdge = function (start, parentBlock) {
        ...
        if (Dom_1.Dom.isText(container)) {
            ...
            var inv = consts.INVISIBLE_SPACE_REG_EXP_START.exec(text);
            if (start &&
    ...
    Select.prototype.setCursorIn = function (node, inStart) {
        ...
        if (!start) {
            var fakeNode = this.jodit.create.inside.text(consts.EMPTY);
    ...
    Select.prototype.applyCSS = function (cssRules, nodeName, options) {
        ...
        if (this.isCollapsed()) {
            ...
            if (nodeName.toUpperCase() === defaultTag || !clearStyle) {
                ...
                node.appendChild(this.jodit.create.inside.text(consts.EMPTY));
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var add_new_line_1 = __webpack_require__(155);
exports.addNewLine = add_new_line_1.addNewLine;
var autofocus_1 = __webpack_require__(156);
exports.autofocus = autofocus_1.autofocus;
var backspace_1 = __webpack_require__(157);
exports.backspace = backspace_1.backspace;
var bold_1 = __webpack_require__(158);
exports.bold = bold_1.bold;
var clean_html_1 = __webpack_require__(159);
...
var color_1 = __webpack_require__(163);
exports.color = color_1.color;
var drag_and_drop_1 = __webpack_require__(164);
exports.DragAndDrop = drag_and_drop_1.DragAndDrop;
var drag_and_drop_element_1 = __webpack_require__(165);
exports.DragAndDropElement = drag_and_drop_element_1.DragAndDropElement;
var enter_1 = __webpack_require__(166);
exports.enter = enter_1.enter;
var error_messages_1 = __webpack_require__(167);
exports.errorMessages = error_messages_1.errorMessages;
var font_1 = __webpack_require__(168);
exports.font = font_1.font;
var format_block_1 = __webpack_require__(169);
exports.formatBlock = format_block_1.formatBlock;
var fullsize_1 = __webpack_require__(170);
exports.fullsize = fullsize_1.fullsize;
var hotkeys_1 = __webpack_require__(171);
exports.hotkeys = hotkeys_1.hotkeys;
var iframe_1 = __webpack_require__(172);
exports.iframe = iframe_1.iframe;
var image_processor_1 = __webpack_require__(173);
exports.imageProcessor = image_processor_1.imageProcessor;
var image_properties_1 = __webpack_require__(174);
exports.imageProperties = image_properties_1.imageProperties;
var indent_1 = __webpack_require__(175);
exports.indent = indent_1.indent;
var inline_popup_1 = __webpack_require__(176);
exports.inlinePopup = inline_popup_1.inlinePopup;
var justify_1 = __webpack_require__(71);
exports.justify = justify_1.justify;
var limit_1 = __webpack_require__(177);
exports.limit = limit_1.limit;
var link_1 = __webpack_require__(178);
exports.link = link_1.link;
var media_1 = __webpack_require__(179);
exports.media = media_1.media;
var mobile_1 = __webpack_require__(180);
exports.mobile = mobile_1.mobile;
var orderedlist_1 = __webpack_require__(181);
exports.orderedlist = orderedlist_1.orderedlist;
var placeholder_1 = __webpack_require__(182);
exports.placeholder = placeholder_1.placeholder;
var redoundo_1 = __webpack_require__(183);
exports.redoundo = redoundo_1.redoundo;
var resizer_1 = __webpack_require__(184);
exports.resizer = resizer_1.resizer;
var search_1 = __webpack_require__(185);
exports.search = search_1.search;
var size_1 = __webpack_require__(186);
exports.size = size_1.size;
var source_1 = __webpack_require__(187);
exports.source = source_1.source;
var stat_1 = __webpack_require__(194);
exports.stat = stat_1.stat;
var sticky_1 = __webpack_require__(195);
exports.sticky = sticky_1.sticky;
var symbols_1 = __webpack_require__(196);
exports.symbols = symbols_1.symbols;
var table_keyboard_navigation_1 = __webpack_require__(197);
exports.tableKeyboardNavigation = table_keyboard_navigation_1.tableKeyboardNavigation;
var table_1 = __webpack_require__(198);
exports.table = table_1.TableProcessor;
var tooltip_1 = __webpack_require__(199);
exports.tooltip = tooltip_1.tooltip;
var xpath_1 = __webpack_require__(200);
...
var helpers_1 = __webpack_require__(2);
var Dom_1 = __webpack_require__(1);
var nl2br_1 = __webpack_require__(160);
...
Config_1.Config.prototype.controls.paste = {
    ...
    exec: function (editor) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var i18n, text, error, items, textBlob, _a, _b, value;
                ...
                switch (_c.label) {
                    ...
                    case 11:
                        ...
                        if (text) {
                            ...
                            if (error) {
                                dialog_1.Alert(i18n("Your browser doesn't support direct access to the clipboard."), function () {
                                    editor.selection.focus();
                                });
                            }
                        }
...
function paste(editor) {
    ...
    var opt = editor.options, clearOrKeep = function (msg, title, callback, clearButton, clear2Button) {
        ...
        var keep = dialog.create.fromHTML("<a href=\"javascript:void(0)\" class=\"jodit_button jodit_button_primary\"><span>" + i18n('Keep') + "</span></a>");
        var clear = dialog.create.fromHTML("<a href=\"javascript:void(0)\" class=\"jodit_button\"><span>" + i18n(clearButton) + "</span></a>");
        var clear2 = dialog.create.fromHTML("<a href=\"javascript:void(0)\" class=\"jodit_button\"><span>" + i18n(clear2Button) + "</span></a>");
        var cancel = dialog.create.fromHTML("<a href=\"javascript:void(0)\" class=\"jodit_button\"><span>" + i18n('Cancel') + "</span></a>");
    ...
    var insertHTML = function (html, event) {
        ...
        if (helpers_1.isHTML(html) && buffer !== trimFragment(html)) {
            ...
            if (opt.askBeforePasteHTML) {
                clearOrKeep(i18n('Your code is similar to HTML. Keep as HTML?'), i18n('Paste as HTML'), function (agree) {
                    ...
                    if (opt.processPasteFromWord && helpers_1.isHTMLFromWord(html)) {
                        ...
                        if (opt.askBeforePasteFromWord) {
                            clearOrKeep(i18n('The pasted content is coming from a Microsoft Word/Excel document. ' +
                                'Do you want to keep the format or clean it up?'), i18n('Word Paste Detected'), function (agree) {
                                var insertType = constants_1.INSERT_AS_HTML;
                                if (agree === false) {
                                    insertType = constants_1.INSERT_AS_TEXT;
                                }
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var dataProvider_1 = __webpack_require__(205);
var ContextMenu_1 = __webpack_require__(39);
...
var Icons = __webpack_require__(210);
var Config_1 = __webpack_require__(3);
var icon_1 = __webpack_require__(6);
...
var storage_1 = __webpack_require__(131);
var helpers_1 = __webpack_require__(2);
...
var Jodit_1 = __webpack_require__(13);
var constants_1 = __webpack_require__(4);
var Async_1 = __webpack_require__(132);
var ProgressBar_1 = __webpack_require__(65);
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var ar_1 = __webpack_require__(137);
var cs_cz_1 = __webpack_require__(138);
var de_1 = __webpack_require__(139);
var en_1 = __webpack_require__(140);
var es_1 = __webpack_require__(141);
var fr_1 = __webpack_require__(142);
var he_1 = __webpack_require__(143);
var hu_1 = __webpack_require__(144);
var id_1 = __webpack_require__(145);
var it_1 = __webpack_require__(146);
var ja_1 = __webpack_require__(147);
var nl_1 = __webpack_require__(148);
var pl_1 = __webpack_require__(149);
var pt_br_1 = __webpack_require__(150);
var ru_1 = __webpack_require__(151);
var tr_1 = __webpack_require__(152);
var zh_cn_1 = __webpack_require__(153);
var zh_tw_1 = __webpack_require__(154);
var exp = {
    ar: ar_1.default,
...
var backspace = (function (_super) {
    ...
    function backspace() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.potentialRemovable = consts.MAY_BE_REMOVED_WITH_KEY;
    ...
    backspace.prototype.onDelete = function (toLeft) {
        ...
        var fakeNode = jodit.create.inside.text(consts.EMPTY);
        ...
        try {
            ...
            if (parent_1 && fakeNode.nodeValue === consts.EMPTY) {
...
var cleanHtml = (function (_super) {
    ...
    cleanHtml.prototype.onRemoveFormat = function () {
        ...
        if (parentNode) {
            var tmp = this.jodit.create.inside.text(consts.EMPTY);
    ...
    cleanHtml.prototype.cleanFragment = function (fragment) {
        ...
        Dom_1.Dom.each(fragment, function (node) {
            if (Dom_1.Dom.isElement(node) && consts.IS_INLINE.test(node.nodeName)) {
    ...
    editor.events
        ...
        var init = function () {
            ...
            var toggleEditable = function () {
                modules_1.Dom.toggleAttribute(doc.body, 'contenteditable', editor.getMode() !== consts.MODE_SOURCE && !editor.getReadOnly());
            };
...
function imageProperties(editor) {
    var i18n = editor.i18n.bind(editor), gi = icon_1.ToolbarIcon.getIcon.bind(icon_1.ToolbarIcon), opt = editor.options, dom = editor.create.fromHTML.bind(editor.create);
    var open = function (e) {
        var _this = this;
        if (opt.readonly) {
            return;
    ...
    var callback = function (command) {
        ...
        editor.selection.eachSelection(function (current) {
            ...
            if (!currentBox && current) {
                currentBox = Dom_1.Dom.wrapInline(current, enter !== consts.BR ? enter : consts.PARAGRAPH, editor);
            }
            if (!currentBox) {
                editor.selection.restore(selectionInfo);
                return false;
...
var placeholder = (function (_super) {
    ...
    placeholder.prototype.isEmpty = function (root) {
        ...
        if (consts.MAY_BE_REMOVED_WITH_KEY.test(first.nodeName) ||
...
var Dom_1 = __webpack_require__(1);
var helpers_1 = __webpack_require__(2);
var factory_1 = __webpack_require__(190);
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var engines_1 = __webpack_require__(191);
...
var stat = (function (_super) {
    ...
    function stat() {
        ...
        _this.calc = _this.jodit.async.throttle(function () {
            ...
            if (_this.jodit.options.showCharsCounter) {
                _this.charCounter.textContent = _this.jodit.i18n('Chars: %d', text.replace(consts.SPACE_REG_EXP, '').length);
            }
            if (_this.jodit.options.showWordsCounter) {
...
var sticky = (function (_super) {
    ...
    function sticky() {
        ...
        _this.createDummy = function (toolbar) {
            if (consts.IS_IE && !_this.dummyBox) {
    ...
    sticky.prototype.afterInit = function (jodit) {
        ...
        jodit.events.on(jodit.ownerWindow, 'scroll wheel mousewheel resize', function () {
            var scrollWindowTop = jodit.ownerWindow.pageYOffset ||
                ...
                0, offsetEditor = size_1.offset(jodit.container, jodit, jodit.ownerDocument, true), doSticky = jodit.getMode() === consts.MODE_WYSIWYG &&
    ...
    popup: function (editor, current, control, close) {
        ...
        if (container) {
            if (editor.options.usePopupForSpecialCharacters) {
                ...
                var dialog_2 = dialog_1.Alert(container, i18n('Select Special Character'), undefined, 'jodit_symbols');
...
var xpath = (function (_super) {
    ...
    function xpath() {
        ...
        _this.calcPathImd = function () {
            ...
            if (_this.container) {
                _this.container.innerHTML = consts.EMPTY;
            }
            if (current) {
...
var contextMenu_1 = __webpack_require__(204);
var observeObject_1 = __webpack_require__(206);
var item_1 = __webpack_require__(207);
...
var ImageEditor = (function (_super) {
    ...
    function ImageEditor(editor) {
        ...
        var i18n = editor.i18n.bind(editor);
        _this.resizeUseRatio = opts.resizeUseRatio;
        _this.cropUseRatio = opts.cropUseRatio;
        ...
        _this.activeTab = opts.resize ? 'resize' : 'crop';
        ...
        _this.editor = _this.jodit.create.fromHTML("<form class=\"" + jie + " jodit_properties\">\n\t\t\t\t\t\t\t<div class=\"jodit_grid\">\n\t\t\t\t\t\t\t\t<div class=\"jodit_col-lg-3-4\">\n\t\t\t\t\t\t\t\t" + (opts.resize
            ...
            : '') + "\n\t\t\t\t\t\t\t\t" + (opts.crop
            ? "<div class=\"" + jie + "_area " + jie + "_area_crop " + act(!opts.resize) + "\">\n\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"" + jie + "_box\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"" + jie + "_croper\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"jodit_bottomright\"></i>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"jodit_sizes\"></i>\n\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t</div>"
            ...
            : '') + "\n\t\t\t\t\t\t\t\t" + (opts.crop
            ? "<div data-area=\"crop\" class=\"" + jie + "_slider " + act(!opts.resize) + "'\">\n\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"" + jie + "_slider-title\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t" + gi('crop') + "\n\t\t\t\t\t\t\t\t\t\t\t\t\t" + i18n('Crop') + "\n\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"" + jie + "_slider-content\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t" + switcher('Keep Aspect Ratio', 'keep_spect_ratio_crop', c) + "\n\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t</div>"
            : '') + "\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</form>");
...
var Uploader = (function (_super) {
    ...
    Uploader.prototype.send = function (url, data, success) {
        var _this = this;
        ...
        if (fileList.length) {
            ...
            for (var i = 0; i < fileList.length; i += 1) {
                ...
                if (file) {
                    ...
                    var ext = file.name.match(/\.([^\.]+)$/i);
                    var extension = (ext && ext[1]) ||
                    ...
                    var newName = file.name ||
                        Math.random()
                            .toString()
                            .replace('.', '');
                    if (extension && !['plain'].includes(extension)) {
            ...
            promises.push(Promise.resolve(prepareDataResult)
                .then(function () {
                var sendFun = uploader.options.customSend ||
                    Uploader.prototype.send;
                return sendFun.call(_this, _this.options.url, form_1, function (resp) {
    ...
    Uploader.prototype.uploadRemoteImage = function (url, handlerSuccess, handlerError) {
        var _this = this;
        var uploader = this;
        uploader.send(this.options.url, {
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var about = __webpack_require__(211);
exports.about = about;
var addcolumn = __webpack_require__(212);
exports.addcolumn = addcolumn;
var addrow = __webpack_require__(213);
exports.addrow = addrow;
var angle_down = __webpack_require__(214);
exports.angle_down = angle_down;
var angle_left = __webpack_require__(215);
exports.angle_left = angle_left;
var angle_right = __webpack_require__(216);
exports.angle_right = angle_right;
var angle_up = __webpack_require__(217);
exports.angle_up = angle_up;
var arrows_alt = __webpack_require__(218);
exports.arrows_alt = arrows_alt;
var arrows_h = __webpack_require__(219);
exports.arrows_h = arrows_h;
var attachment = __webpack_require__(220);
exports.attachment = attachment;
var bin = __webpack_require__(221);
exports.bin = bin;
var bold = __webpack_require__(222);
exports.bold = bold;
var brush = __webpack_require__(223);
exports.brush = brush;
var cancel = __webpack_require__(224);
exports.cancel = cancel;
var center = __webpack_require__(225);
exports.center = center;
var chain_broken = __webpack_require__(226);
exports.chain_broken = chain_broken;
var check = __webpack_require__(227);
exports.check = check;
var check_square = __webpack_require__(228);
exports.check_square = check_square;
var copyformat = __webpack_require__(229);
exports.copyformat = copyformat;
var crop = __webpack_require__(230);
exports.crop = crop;
var copy = __webpack_require__(231);
exports.copy = copy;
var cut = __webpack_require__(232);
exports.cut = cut;
var dedent = __webpack_require__(233);
exports.dedent = dedent;
var dots = __webpack_require__(234);
exports.dots = dots;
var dropdown_arrow = __webpack_require__(235);
exports.dropdown_arrow = dropdown_arrow;
var enter = __webpack_require__(236);
exports.enter = enter;
var eraser = __webpack_require__(237);
exports.eraser = eraser;
var eye = __webpack_require__(238);
exports.eye = eye;
var file = __webpack_require__(239);
exports.file = file;
var folder = __webpack_require__(240);
exports.folder = folder;
var font = __webpack_require__(241);
exports.font = font;
var fontsize = __webpack_require__(242);
exports.fontsize = fontsize;
var fullsize = __webpack_require__(243);
exports.fullsize = fullsize;
var hr = __webpack_require__(244);
exports.hr = hr;
var image = __webpack_require__(245);
exports.image = image;
var indent = __webpack_require__(246);
exports.indent = indent;
var info_circle = __webpack_require__(247);
exports.info_circle = info_circle;
var italic = __webpack_require__(248);
exports.italic = italic;
var justify = __webpack_require__(249);
exports.justify = justify;
var left = __webpack_require__(250);
exports.left = left;
var link = __webpack_require__(251);
exports.link = link;
var lock = __webpack_require__(252);
exports.lock = lock;
var menu = __webpack_require__(253);
exports.menu = menu;
var merge = __webpack_require__(254);
exports.merge = merge;
var ol = __webpack_require__(255);
exports.ol = ol;
var omega = __webpack_require__(256);
exports.omega = omega;
var outdent = __webpack_require__(257);
exports.outdent = outdent;
var palette = __webpack_require__(258);
exports.palette = palette;
var paragraph = __webpack_require__(259);
exports.paragraph = paragraph;
var paste = __webpack_require__(260);
exports.paste = paste;
var pencil = __webpack_require__(261);
exports.pencil = pencil;
var plus = __webpack_require__(262);
exports.plus = plus;
var print = __webpack_require__(263);
exports.print = print;
var redo = __webpack_require__(264);
exports.redo = redo;
var resize = __webpack_require__(265);
exports.resize = resize;
var resizer = __webpack_require__(266);
exports.resizer = resizer;
var right = __webpack_require__(267);
exports.right = right;
var save = __webpack_require__(268);
exports.save = save;
var select_all = __webpack_require__(269);
exports.select_all = select_all;
var shrink = __webpack_require__(270);
exports.shrink = shrink;
var source = __webpack_require__(271);
exports.source = source;
var splitg = __webpack_require__(272);
exports.splitg = splitg;
var splitv = __webpack_require__(273);
exports.splitv = splitv;
var strikethrough = __webpack_require__(274);
exports.strikethrough = strikethrough;
var subscript = __webpack_require__(275);
exports.subscript = subscript;
var superscript = __webpack_require__(276);
exports.superscript = superscript;
var table = __webpack_require__(277);
exports.table = table;
var th = __webpack_require__(278);
exports.th = th;
var th_list = __webpack_require__(279);
exports.th_list = th_list;
var ul = __webpack_require__(280);
exports.ul = ul;
var underline = __webpack_require__(281);
exports.underline = underline;
var undo = __webpack_require__(282);
exports.undo = undo;
var unlink = __webpack_require__(283);
exports.unlink = unlink;
var unlock = __webpack_require__(284);
exports.unlock = unlock;
var update = __webpack_require__(285);
exports.update = update;
var upload = __webpack_require__(286);
exports.upload = upload;
var valign = __webpack_require__(287);
exports.valign = valign;
var video = __webpack_require__(288);
exports.video = video;
...
module.exports = "<svg viewBox=\"0 0 1792 1792\"> <path d=\"m 733.76105,905.23349 -450.06,450.06001 c -43.44,43.46 -43.44,113.9 0,157.36 21.72,21.72 50.2,32.58 78.68,32.58 v 0 c 28.48,0 56.96,-10.86 78.68,-32.58 l 450.06,-450.06 450.03995,450.04 c 21.72,21.72 50.2,32.58 78.68,32.58 v 0 c 28.48,0 56.96,-10.86 78.68,-32.6 43.46,-43.46 43.46,-113.9 0,-157.36 l -450.04,-450.04001 450.04,-450.04 c 43.46,-43.46 43.46,-113.92 0,-157.36 -43.46,-43.44 -113.92,-43.46 -157.36,0 l -450.03995,450.04 -450.06,-450.06 c -43.46,-43.46 -113.92,-43.44 -157.36,0 -43.44,43.44 -43.44,113.92 0,157.36 l 450.06,450.06 z\"></path> </svg> "
